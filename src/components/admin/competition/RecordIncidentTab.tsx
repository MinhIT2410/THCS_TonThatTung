            ...
            {selectedStudent ? (
              <div className="p-4 rounded-2xl bg-blue-50/70 dark:bg-blue-950/40 border border-blue-200 dark:border-blue-800 flex items-center justify-between">
                ...
                <button
                  ...
                  className="p-1.5 rounded-lg hover:bg-blue-100 dark:hover:bg-blue-900 text-slate-500 transition-colors"
                  title="Đổi đội viên"
                >
                  <X className="w-5 h-5" />
                </button>
                  ...
                  <div className="absolute z-20 left-0 right-0 mt-1 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-2xl shadow-xl max-h-60 overflow-y-auto divide-y divide-slate-100 dark:divide-slate-800">
                    {searchResults.map(s => (
                      <button
                        ...
                        className="w-full text-left p-3 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors flex items-center justify-between"
                      >
                        <div>
            ...
            <div className="space-y-4 pt-2 border-t border-slate-100 dark:border-slate-800">
              ...
              <div>
                <input
                  ...
                  className="w-full px-3.5 py-2 py-2 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 text-xs text-slate-900 dark:text-white outline-none mb-3"
                />
              </div>
        ...
        <div className="lg:col-span-4 space-y-6">
          <div className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-3xl p-6 shadow-sm space-y-6 sticky top-6">
            ...
            <button
              ...
              className="w-full py-3.5 px-6 rounded-2xl bg-red-600 hover:bg-red-700 active:scale-[0.99] text-white font-bold text-sm shadow-lg shadow-red-600/25 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {isSubmitting ? (
                <>
