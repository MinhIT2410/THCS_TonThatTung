  ...
  return (
    <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <EditableBlock
        ...
        error={error}
      >
        <div className="flex flex-col md:flex-row items-center justify-between rounded-[2rem] bg-gradient-to-r from-red-600 via-purple-700 to-blue-700 p-6 md:p-8 text-white shadow-2xl relative overflow-hidden group border border-white/10">
          ...
          <div className="flex flex-col sm:flex-row items-center sm:items-start space-y-4 sm:space-y-0 sm:space-x-5 mb-5 md:mb-0 relative z-10 text-center sm:text-left">
            ...
            <div className="space-y-1.5 max-w-2xl">
              ...
              <h3 className="text-base sm:text-lg font-extrabold font-sans leading-snug tracking-tight drop-shadow-sm group-hover:text-yellow-50 transition-colors">
                {data.title || "Chương trình phát thanh kỳ này..."}
              </h3>
              {data.description && (
                <p className="text-xs text-slate-200/85 leading-relaxed font-sans font-medium line-clamp-1">
                  {data.description}
                </p>
              )}
            </div>
