...
export default function AdminDocumentsPage() {
  ...
  return (
    <div className="space-y-6 py-4 font-sans" id="admin-documents-page">
      {/* Page Header */}
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-slate-200 dark:border-slate-800 pb-5">
        <div className="space-y-1">
          <div className="flex items-center space-x-2.5">
            <FileText className="h-6 w-6 text-indigo-600 dark:text-indigo-400" />
            <h1 className="font-display text-xl font-bold text-slate-900 dark:text-white">Quản lý tài liệu</h1>
          </div>
          <p className="text-xs text-slate-500 dark:text-slate-400">Quản lý, lưu trữ và lưu hành tài liệu văn bản công vụ của trường.</p>
        </div>
        <button
      ...
      <div className="bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-3xl p-8 sm:p-12 text-center max-w-2xl mx-auto space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400 max-w-md mx-auto leading-relaxed">
            Upload và quản lý văn bản/tài liệu sẽ được bổ sung ở Prompt 12. Hãy quay lại sau khi tính năng này được cập nhật đầy đủ.
          </p>
        </div>
