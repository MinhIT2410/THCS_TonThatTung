...
export default function AdminUsersPage() {
  ...
  return (
    <div className="space-y-6 py-4 font-sans" id="admin-users-page">
      {/* Page Header */}
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-slate-200 dark:border-slate-800 pb-5">
        <div className="space-y-1">
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400">Danh sách tài khoản cán bộ giáo viên và điều khiển phân quyền vai trò.</p>
        </div>
        <button
      ...
      <div className="bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-3xl p-8 sm:p-12 text-center max-w-2xl mx-auto space-y-6">
        <div className="p-4 bg-cyan-50 dark:bg-cyan-950/20 text-cyan-600 dark:text-cyan-400 rounded-2xl w-16 h-16 flex items-center justify-center mx-auto shadow-sm border border-cyan-100/40 dark:border-cyan-900/30">
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400 max-w-md mx-auto leading-relaxed">
            Phân quyền người dùng và quản lý danh sách tài khoản sẽ được bổ sung ở Prompt 15. Hãy quay lại sau khi tính năng này được cập nhật đầy đủ.
          </p>
        </div>
