...
import { X, AlertTriangle, Shield, User, Mail, KeyRound, Loader2 } from 'lucide-react';
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-fade-in font-sans">
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-5">
            ...
            {/* Email đăng nhập (Chỉ đọc & Nút đặt lại mật khẩu) */}
            <div className="space-y-1.5">
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="w-full px-4 py-2.5 text-xs rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50/80 dark:bg-slate-900/80 text-slate-600 dark:text-slate-300 font-medium cursor-not-allowed outline-none"
                ...
                {onResetPassword && (
                  <button
                    ...
                    className="shrink-0 px-3 py-2.5 bg-amber-50 hover:bg-amber-100 dark:bg-amber-950/40 dark:hover:bg-amber-950/80 border border-amber-200 dark:border-amber-900/50 text-amber-800 dark:text-amber-300 text-xs font-bold rounded-xl transition-all flex items-center gap-1.5 cursor-pointer shadow-xs"
                    title="Đặt lại mật khẩu mới cho tài khoản này"
                    id="btn-open-reset-password-modal"
                  >
            ...
            <div className="flex justify-end gap-2.5 pt-4 border-t border-slate-100 dark:border-slate-900">
              ...
              <button
                type="submit"
                disabled={isSubmitting}
                className="px-4 py-2.5 text-xs font-bold text-white bg-blue-600 hover:bg-blue-700 rounded-xl transition-colors flex items-center justify-center gap-1.5 min-w-[80px] cursor-pointer"
              >
                {isSubmitting ? (
                  <>
