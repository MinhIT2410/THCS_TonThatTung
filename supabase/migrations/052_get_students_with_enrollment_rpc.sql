...
-- 052_get_students_with_enrollment_rpc.sql
-- RPC for paginated student enrollment lookup with search and filters
...
revoke all on function public.get_students_with_enrollment(uuid, uuid, text, boolean, boolean, integer, integer) from public;
grant execute on function public.get_students_with_enrollment(uuid, uuid, text, boolean, boolean, integer, integer) to authenticated;
